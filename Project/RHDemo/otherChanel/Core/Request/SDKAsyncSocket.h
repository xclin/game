...
@interface SDKAsyncSocket : NSObject
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(SDKAsyncSocket *)sock;
...
**/
- (void)socket:(SDKAsyncSocket *)sock didAcceptNewSocket:(SDKAsyncSocket *)newSocket;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(SDKAsyncSocket *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (void)socket:(SDKAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(SDKAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(SDKAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(SDKAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(SDKAsyncSocket *)sock;
...
**/
- (void)socketDidDisconnect:(SDKAsyncSocket *)sock withError:(nullable NSError *)err;
...
**/
- (void)socketDidSecure:(SDKAsyncSocket *)sock;
...
**/
- (void)socket:(SDKAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
