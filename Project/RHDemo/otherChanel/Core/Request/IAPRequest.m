...
@interface IAPRequest()<NSURLSessionDelegate>
@end
@implementation IAPRequest {
    NSURLSession * sesssion;
    NSOperationQueue * queue;
}
LQSingletonInstanceMMethod(IAPRequest, ^{
    [instance setUP];
})
...
- (nullable NSArray *)defaultPayPinnedCertificates {
    ...
    dispatch_once(&onceToken,^{
        ...
        NSString *certFilePath = [bundle pathForResource:PAYURL ofType:@"cer"];
...
+ (void) post:(BBModel *)model tryTime:(NSInteger)time succeed:(void (^)(id))complete
{
